...
import { k as getDefaultExportFromCjs, z } from './astro/server_BKnKrizw.mjs';
...
function drizzle(...params) {
  ...
  if (isConfig(params[0])) {
    ...
    const instance = typeof connection === "string" ? createClient$1({ url: connection }) : createClient$1(connection);
...
function createClient(opts) {
  ...
  const client = createClient$1({ ...libSQLOptions, url, authToken: token });
...
const db = await createClient({
  url: "libsql://playground-shuhib1924.aws-eu-west-1.turso.io",
  token: process.env.ASTRO_DB_APP_TOKEN
});
const Todo_a1 = asDrizzleTable("Todo_a1", { "columns": { "id": { "type": "number", "schema": { "unique": true, "deprecated": false, "name": "id", "collection": "Todo_a1", "primaryKey": true } }, "title": { "type": "text", "schema": { "unique": false, "deprecated": false, "name": "title", "collection": "Todo_a1", "primaryKey": false, "optional": false } }, "completed": { "type": "boolean", "schema": { "optional": false, "unique": false, "deprecated": false, "name": "completed", "collection": "Todo_a1", "default": false } }, "priority": { "type": "number", "schema": { "unique": false, "deprecated": false, "name": "priority", "collection": "Todo_a1", "primaryKey": false, "optional": false, "default": 0 } }, "created_at": { "type": "date", "schema": { "optional": false, "unique": false, "deprecated": false, "name": "created_at", "collection": "Todo_a1", "default": { "__serializedSQL": true, "sql": "CURRENT_TIMESTAMP" } } }, "updated_at": { "type": "date", "schema": { "optional": false, "unique": false, "deprecated": false, "name": "updated_at", "collection": "Todo_a1", "default": { "__serializedSQL": true, "sql": "CURRENT_TIMESTAMP" } } } }, "indexes": {} });

export { Todo_a1 as T, db as d, eq as e };
